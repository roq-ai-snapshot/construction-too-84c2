  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience unparalleled convenience with Construction Tool Rental v1 - Your one-stop destination for renting construction tools from multiple outlets."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience unparalleled convenience with Construction Tool Rental v1 - Your one-stop destination for renting construction tools from multiple outlets.`}
            </Text>
            <Box
